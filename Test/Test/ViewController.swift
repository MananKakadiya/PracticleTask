...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let btnModuleOne = UIViews.makeButton(title: "Module 1", titleColor: .black, font: UIFont.init(name: "Arial", size: 15.0), background: .white, cornerRadius: 3.0, borderWidth: 2)
        ...
        let btnModuleTwo = UIViews.makeButton(title: "Module 2", titleColor: .black, font: UIFont.init(name: "Arial", size: 15.0), background: .white, cornerRadius: 3.0, borderWidth: 2)
